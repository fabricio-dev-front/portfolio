    ...
    <div>
      <div className="mb-8 md:mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-3">
        ...
        <p className="text-xs text-muted-text max-w-sm sm:text-right leading-relaxed">
          Disponível para novos projetos, consultoria técnica, desenvolvimento
          de software e soluções com Inteligência Artificial.
        </p>
      </div>

      <div className="rounded-2xl bg-card border border-card-border shadow-xs p-6 md:p-8 relative overflow-hidden">
        <div
        ...
        <div className="mb-6">
          ...
          <p className="text-xs md:text-sm text-muted-text leading-relaxed">
            Preencha os campos abaixo e entrarei em contato o mais breve
            possível.
          </p>
        </div>
